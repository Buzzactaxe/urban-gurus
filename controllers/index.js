...
module.exports = {
	...
	async updateProfile(req, res, next) {
		...
		// check if username email or image need to be updated
	...
	async putForgotPw(req, res, next) {
		...
		const msg = {
			to      : user.email,
			from    : 'Urban Gurus Admin <your@email.com>',
			subject : 'Urban Gurus - Forgot Password / Reset',
	...
	async putReset(req, res, next) {
		...
		const msg = {
			to      : user.email,
			from    : 'Urban Gurus Admin <your@email.com>',
			subject : 'Urban Gurus - Password Changed',
			text    : `Hello,
